...
export const CDNRoutes = {
	 ...
	 * This route supports the extensions: PNG, JPEG, WebP
	 */
	serverTagBadge<Format extends ServerTagBadgeFormat>(guildId: Snowflake, serverTagBadge: string, format: Format) {
		return `/clan-badges/${guildId}/${serverTagBadge}.${format}` as const;
	},
};
...
export type ServerTagBadgeFormat = Exclude<ImageFormat, ImageFormat.GIF | ImageFormat.Lottie>;
