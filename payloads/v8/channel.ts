...
export enum ChannelType {
	 ...
	 *
	 * See https://docs.discord.com/developers/game-and-server-management/special-channels
	 */
	GuildStore,
	/**
...
export interface APIMessage {
	 ...
	 * Sent with Rich Presence-related chat embeds
	 *
	 * See https://docs.discord.com/developers/resources/channel#message-object-message-application-structure
	 */
	 ...
	 *
	 * See https://docs.discord.com/developers/resources/channel#message-object-message-reference-structure
	 */
...
/**
 * https://docs.discord.com/developers/resources/channel#message-object-message-reference-structure
 *
 * @deprecated API and gateway v8 are deprecated and the types will not receive further updates, please update to v10.
 */
...
/**
 * https://docs.discord.com/developers/interactions/message-components#component-types
 *
 * @deprecated API and gateway v8 are deprecated and the types will not receive further updates, please update to v10.
 */
