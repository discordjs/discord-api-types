...
You can also check [`Discord's API versioning table`](https://docs.discord.com/developers/reference#api-versioning) if
...
[`Discord's gateway`](https://docs.discord.com/developers/topics/gateway). It stores the gateway version the types are
...
[`Discord's RPC API`](https://docs.discord.com/developers/topics/rpc). Just like [`gateway`](#gateway), each RPC API
...
This folder holds types that are strictly related to
[`Discord's Voice API`](https://docs.discord.com/developers/topics/voice-connections). It follows the same folder
